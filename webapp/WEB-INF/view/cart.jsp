	...
	<div class="col-md-10">
				...
				<c:forEach var="cartDetail" items="${cartDetails}">
					<tr id="tivi${cartDetail.tivi.id}">
						...
						<td><input class="form-control" type="number"
							id="quantity${cartDetail.tivi.id}" value="${cartDetail.quantity}"
							max="99" onchange="changeQuantity(${cartDetail.tivi.id},this)"></td>
		...
		<div class="row">
			<div class="d-grid gap-2 col-6 m-auto mb-4">
				<a href="/PH18485_ASM/cart/check-out" class="btn btn-primary"
